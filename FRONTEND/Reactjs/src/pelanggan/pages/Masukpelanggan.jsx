                    ...
                    <div className="mt-3 mb-5 col-7 p-0">
                            <div class="card "  style={{borderColor: '#4F5C92'}}>
                                <div class="card-body p-4 "> 
                                    ...
                                    <h6 className="card-title text-center mb-5 fw-semibold">Masuk untuk memulai pesanan Anda</h6>
                                    <div>
                                        <div class="container">
                                        ...
                                        <div class="container text-center">
                                            <div class="row justify-content-md-center">
                                            <div class="col-10 mb-4">
                                            <a onClick={() => navigate('/Landinguser')}  id="button" href="" style={{marginLeft: '290px'}}>Masuk</a>
                                            </div>
                                            </div>
                                            <br></br>
                                        </div>
                                        <div class="container text-center">
                                            ...
                                            <p onClick={() => navigate('/Daftarpelanggan')}><a class="link-offset-2 link-underline link-underline-opacity-0" href="#" style={{color: '#4F5C92'}}>Buat Akun Sebagai Pelanggan</a></p>
                                            </div>
                                            </div>
                                        </div>
                                    </div>

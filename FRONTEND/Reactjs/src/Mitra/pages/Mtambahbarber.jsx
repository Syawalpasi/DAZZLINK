...
import Modalcancel2 from "../component/Modalcancel2";
import ModalscancelM2 from "../component/ModalcancelM2";




function Modalbarber() {
  ...
  <Navbar  className="shadow p-3 mb-5 ">
                        ...
                        <div class="container ">
                            <div class="row">
                                ...
                                <div class="col"  >
                                <h5 class="card-title mt-1  fs-4 fw-semibold">Tambah Barber Anda</h5>
                                </div>
                            </div>
                        </div>
                        </Navbar.Brand>
                        <Navbar.Brand href="#home justify-content-end ">
                        <ModalscancelM2></ModalscancelM2>
                        </Navbar.Brand>
                        </Container>
            </Navbar>
...
<div className="col-5"style={{marginLeft: '33rem' }}  >            
              <br></br>
              <br></br>
              <br></br>        
